...
pub extern fn leveldb_get(db: ?*leveldb_t, options: ?*const leveldb_readoptions_t, key: [*c]const u8, keylen: usize, vallen: [*c]usize, errptr: [*c][*c]u8) [*c]u8;
...
pub extern fn leveldb_writebatch_iterate(?*const leveldb_writebatch_t, state: ?*anyopaque, put: ?*const fn (?*anyopaque, [*c]const u8, usize, [*c]const u8, usize) callconv(.C) void, deleted: ?*const fn (?*anyopaque, [*c]const u8, usize) callconv(.C) void) void;
...
pub const leveldb_no_compression: c_int = 0;
pub const leveldb_snappy_compression: c_int = 1;
const enum_unnamed_1 = c_uint;
pub extern fn leveldb_options_set_compression(?*leveldb_options_t, c_int) void;
pub extern fn leveldb_comparator_create(state: ?*anyopaque, destructor: ?*const fn (?*anyopaque) callconv(.C) void, compare: ?*const fn (?*anyopaque, [*c]const u8, usize, [*c]const u8, usize) callconv(.C) c_int, name: ?*const fn (?*anyopaque) callconv(.C) [*c]const u8) ?*leveldb_comparator_t;
pub extern fn leveldb_comparator_destroy(?*leveldb_comparator_t) void;
pub extern fn leveldb_filterpolicy_create(state: ?*anyopaque, destructor: ?*const fn (?*anyopaque) callconv(.C) void, create_filter: ?*const fn (?*anyopaque, [*c]const [*c]const u8, [*c]const usize, c_int, [*c]usize) callconv(.C) [*c]u8, key_may_match: ?*const fn (?*anyopaque, [*c]const u8, usize, [*c]const u8, usize) callconv(.C) u8, name: ?*const fn (?*anyopaque) callconv(.C) [*c]const u8) ?*leveldb_filterpolicy_t;
...
pub const STORAGE_LEVELDB_INCLUDE_C_H_ = "";
...
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stdarg_va_copy.h:11:9
...
// /Users/tomasroda/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/__stddef_offsetof.h:16:9
...
pub const STORAGE_LEVELDB_INCLUDE_EXPORT_H_ = "";
pub const LEVELDB_EXPORT = "";
